...
The main goal of this exercise was to build an API that in NodeJS and ExpressJS that uses TypeScript including tests - Jest - and documentation - swagger.

As a secondary goal was to learn how to work together so we can successfully complete larger projects in the future. To achieve this we drew from each other's work and life experience and we were able to establish patterns that worked well for us and facilitated fluid communication and standards clarity.
...
- A User can update a menu recipes individually without having to regenerate the whole batch.
